...
const ROOT_SITE_ATTRIBUTE =
  /(href|src)=(['"])((?:index\.html|styles\.css|script\.js|robots\.txt|sitemap\.xml|ads\.txt|(?:data|assets|songs|artists|countries|years|timeline|listen|glossary|about|contact|privacy)\/)[^'"]*)(\2)/g;
