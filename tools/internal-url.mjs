...
const ROOT_SITE_ATTRIBUTE =
  /(href|src)=(['"])((?:index\.html|styles\.css|script\.js|robots\.txt|sitemap\.xml|ads\.txt|(?:data|assets|songs|artists|countries|years|timeline|listen|glossary|about|contact|privacy|world-cup-2026-closing-ceremony|world-cup-2026-final-halftime-show)\/)[^'"]*)(\2)/g;
