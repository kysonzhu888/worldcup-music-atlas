  ...
  return `<main class="article-page" data-page="world-cup-2026-closing-ceremony">
    ...
    <section class="detail-hero">
      ...
      <div class="hero-actions">
        ...
        <a class="button secondary" href="../world-cup-2026-final-halftime-show/" data-conversion="related_page" data-target-key="final_halftime_show">Compare the halftime show</a>
      </div>
    </section>
    ...
    <section class="detail-grid">
      <article class="detail-main">
        ...
        <section class="explainer-block" aria-labelledby="halftime-difference-title">
          ...
          <p>The closing ceremony is a pre-match event, not the Final Halftime Show. It starts 90 minutes before kick-off and celebrates the tournament before the final begins. The <a class="text-link" href="../world-cup-2026-final-halftime-show/" data-conversion="related_page" data-target-key="final_halftime_show">Final Halftime Show</a> is a separate 11-minute broadcast during the match interval with a separately announced lineup.</p>
        ...
        <section class="explainer-block" aria-labelledby="music-connection-title">
          ...
          <p>IShowSpeed is confirmed for the closing ceremony. His track <a class="text-link" href="../songs/champion-ishowspeed/" data-conversion="related_page" data-target-key="champion">Champion</a> is also part of the official FIFA World Cup 2026 album, which makes it a relevant route through the music atlas.</p>
      ...
      <aside class="detail-aside" aria-label="Closing ceremony facts and related guides">
        ...
        <aside class="ad-slot detail-ad" aria-label="Related World Cup music guides">
          ...
          <div class="ad-slot-links">
            <a class="text-link" href="../world-cup-2026-final-halftime-show/" data-conversion="related_page" data-target-key="final_halftime_show">Final Halftime Show</a>
            <a class="text-link" href="../songs/champion-ishowspeed/" data-conversion="related_page" data-target-key="champion">Champion</a>
            <a class="text-link" href="../artists/ishowspeed/" data-conversion="related_page" data-target-key="ishowspeed">IShowSpeed</a>
            <a class="text-link" href="../years/2026/" data-conversion="related_page" data-target-key="year_2026">2026 collection</a>
          </div>
        </aside>
      </aside>
    </section>
